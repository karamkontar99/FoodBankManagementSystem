...
public class ReceiveDonations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DonationRepository.getAcceptedDonations(donations -> setConfigDonations(recyclerView, searchView, donations), message ->
    ...
    private void setConfigDonations(RecyclerView recyclerView, SearchView searchView, List<Donation> donations) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ReceiveDonations.this));
    ...
    private class DonationViewHolder extends RecyclerView.ViewHolder {
        ...
        public DonationViewHolder(ViewGroup parent) {
            super(LayoutInflater.from(ReceiveDonations.this).inflate(R.layout.donation_list_item, parent, false));
                ...
                new AlertDialog.Builder(ReceiveDonations.this)
                        ...
                        .setPositiveButton("Accept", (dialog, which) -> {
                            ...
                            DonationRepository.putDonation(donation, d -> {
                                        Toast.makeText(ReceiveDonations.this, "status updated", Toast.LENGTH_SHORT).show();
